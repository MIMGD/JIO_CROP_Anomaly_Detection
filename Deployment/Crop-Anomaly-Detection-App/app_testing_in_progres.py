...
def detect_object(uploaded_image_path):
    ...
    # Load tf
    tf_weight = "saved_model/saved_model.pb"
    tf_config = "saved_model/pipeline.config"
    image_labels = "saved_model/annotation.pbtxt"
    net = cv2.dnn.readNet(tf_weight, tf_config)
    ...
    # Set input for tf object detection
    net.setInput(blob)
